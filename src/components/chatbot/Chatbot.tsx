...
function getReply(input: string) {
  ...
  const money = (value: number) => currency(value, state.settings.currency, state.settings.language, state.settings.hideAmounts)
