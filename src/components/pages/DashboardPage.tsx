...
export function DashboardPage() {
  ...
  return <div className="dashboard-page route-view">
    <section className="welcome-hero hero-in">
      ...
      <div className="welcome-copy"><div className="eyebrow"><Sparkles size={14} /> {t('clarity')}</div><h1>{greeting}, {profile.name.split(' ')[0]} <span>✦</span></h1><p>{shortDate(today, settings.language, settings.dateFormat)} · {t('essentials')}</p></div>
